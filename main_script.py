...
def executar_assistente_legislativo():
    ...
    try:
        ...
        df_lista_deputados = pd.read_sql_query("SELECT DISTINCT `deputado_.nome` FROM votos_deputados", conn)
        lista_nomes_deputados = df_lista_deputados['deputado_.nome'].str.upper().tolist()
