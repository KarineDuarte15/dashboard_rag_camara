# Arquivo: etl_andre/Input_usuario.py
import sqlite3
import pandas as pd
...
from etl_andre.cruzamento_dados import processar_cruzamento

load_dotenv()
API_KEY = os.getenv("GEMINI_API_KEY")

if not API_KEY:
    raise ValueError("⚠️ Chave GEMINI_API_KEY não encontrada no arquivo .env!")
